...
func (c *Composition) issueCommand(args []string, dir string) (_ []byte, err error) {
	...
	cmd := exec.Command(dockerComposeCommand, cmdArgs...) // nolint:gosec // docker compose args
	cmd.Dir = dir
...
func GenerateBytesUUID() []byte {
	...
	uuid[8] = uuid[8]&^0xc0 | 0x80 // nolint:gomnd // variant bits?

	// version 4 (pseudo-random); see section 4.1.3
	uuid[6] = uuid[6]&^0xf0 | 0x40 // nolint:gomnd // variant bits?
